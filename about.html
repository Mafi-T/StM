...
<div class="super_container">
		...
		<div class="menu trans_400" style="background-color: black;">
			...
			<nav class="menu_nav" >
				<ul>
					<li><a href="index.html" class="big">Home</a></li>
					<li><a href="about.php"  style="color:aqua" >About us</a></li>
					<li><a href="services.php">Services</a></li>
					<li><a href="staff.php">Our Staff</a></li>
					<li><a href="contact.php">Contact</a></li>
				</ul>
	...
	<div class="home d-flex flex-column align-items-start justify-content-end"  >
		...
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="images/0.jpg" data-speed="0.8"></div>
				...
				<div class="col-lg-8">
					<div class="intro_content">
						<div class="section_title_container">
							<div class="section_subtitle">This is St Michael</div>
							...
							<div class="row milestones_row">
								...
								<div class="col-md-3 milestone_col">
									<div class="milestone">
										...
										<div class="milestone_text">Covid Tests</div>
									</div>
								</div>
				...
				<div class="col">
					<div class="cta_container d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start">
						<div class="cta_content">
							<div class="cta_title">ዛሬውኑ ደወለው ቀጠሮዎን ያስይዙ!!</div>
							<div class="cta_text">ጤናዎን ለመጠበቅ ጊዜ መውሰድ አያስፈልግም። ጊዜውን የጠበቅ ምርመራ ማድረግ ........</div>
						</div>
						<div class="cta_phone ml-lg-auto">+251 586 778 8892</div>
					</div>
				</div>
			</div>
		</div>
